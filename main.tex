...
\documentclass[degree=bachelor, section-style=arabic]{ustcthesis}
...
\include{chapters/LLP.tex}
\include{chapters/detector.tex}
\include{chapters/data.tex}
\include{chapters/NN.tex}
\include{chapters/result.tex}

\bibliography{bib/main}  % 参考文献使用 BibTeX 编译
